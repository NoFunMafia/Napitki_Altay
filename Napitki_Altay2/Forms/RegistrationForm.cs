    ...
    public partial class RegistrationForm : Form
    {
        ...
        private void SendAnEmail()
        {
            ...
            mimeMessage.Body = new TextPart("html")
            {
                ...
                $"<p>Благодарим Вас за регистрацию в приложении «Система Образования, Взаимодействия и Аналитики». Ваш доступ к сервисам автоматизированной обработки документов будет активирован после завершения процедуры подтверждения.</p>" +

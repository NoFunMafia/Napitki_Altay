...
{
    public partial class FormStyleCustom : Component
    {
        #region -- Свойста --
        ...
        private Dictionary<fStyle, StyleForm> StylesDictionary; // Словарь вида: <Стиль из набора, Объект стиля с параметрами>
        private StyleForm CurrentStyle; // Актуальный стиль, класс с его параметрамы
        ...
        public FormStyleCustom()
        {
            InitializeComponent();
        }
        public FormStyleCustom(IContainer container)
        {
            DefineStyles();
        ...
        {
            StylesDictionary = new Dictionary<fStyle, StyleForm>();
            ...
            StylesDictionary.Add(fStyle.SimpleDark,
                new StyleForm()
                {
                    ...
                    HeaderHeight = 38,
                    HeaderColor = TesterColor.WetAsphalt,
            ...
            StylesDictionary.Add(fStyle.TelegramStyle,
                new StyleForm()
                {
                    ...
                    BackColor = Color.White,
                    HeaderHeight = 20,
                    HeaderColor = TesterColor.GrayLight2,
        ...
        private void SaveNoneStyleConfig()
        {
            ...
            {
                StyleForm NoneStyle = StylesDictionary[fStyle.None];
        ...
        private void SaveUserStyleConfig()
        {
            if (StylesDictionary.ContainsKey(fStyle.UserStyle) && StyleUsed == false)
            {
                ...
                StyleForm UserStyle = StylesDictionary[fStyle.UserStyle];
        ...
        private void DrawStyle(Graphics graph)
        {
            ...
            if (Form.ControlBox == true)
            {
                ...
                graph.DrawRectangle(new Pen(btnCloseHovered ? TesterColor.Red2 : Color.Transparent), rectBtnClose);
                graph.FillRectangle(new SolidBrush(btnCloseHovered ? TesterColor.Red2 : Color.Transparent), rectBtnClose);
